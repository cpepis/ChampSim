...
def define_cpu_patterns():
    ...
    return {
        ...
        "cycles": r"cycles: (\d+)",
        "BranchPrediction Accuracy": r"Branch Prediction Accuracy: ([\d.]+)%",
        "MPKI": r"MPKI: ([\d.]+)",
        ...
        "Unique Loads": r"Unique Loads: (\d+)",
        "Unique Load Misses": r"Unique Load Misses: (\d+)",
        "Repeated Load Misses": r"Repeated Load Misses: (\d+)",
        "Unique Load Addresses": r"Unique Load Addresses: (\d+)",
        "Repeated Load Addresses": r"Repeated Load Addresses: (\d+)",
        "Load Misses": r"Load Misses: (\d+)",
        "Merged Loads": r"Merged Loads: (\d+)",
        "Dedected Load Misses": r"Dedected Load Misses: (\d+)",
