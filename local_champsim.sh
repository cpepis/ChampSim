...
bin/champsim --warmup-instructions 10000000 --simulation-instructions 100000000 --scheduling-flush --reschedule-only-branches ../traces/400.perlbench-41B.champsimtrace.xz >sfb-trace.log
